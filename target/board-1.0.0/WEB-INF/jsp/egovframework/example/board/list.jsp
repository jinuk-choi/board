...
<div class="container">
	...
	<div class="panel panel-default">
		...
		<c:if test="${sessionScope != null && sessionScope.userId != null && sessionScope.userId != '' }">
			...
			<button type="button" class="btn btn-default" oneclick="out();">로그아웃</button>
		</c:if>				 
		</div>
				...
				<div class="table-responsive">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><a href ="javascript:view();">안녕</a></td>
				        <td>1</td>
				        <td>관리자</td>
				        <td>2021-06-04</td>
				      </tr>
		 ...
		 <c:if test="${!empty sessionScope.userId }">
			<button type="button" class="btn btn-default" oneclick="add();">등록</button>
		</c:if>
		 </div>
	</div>
</div>
